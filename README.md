...
## Install (Amplitude US endpoint only)
...
To update your repositories after the initial installation from Amplitude, visit the [Amplitude GitHub app](https://github.com/apps/amplitude) and click `Configure`.
